...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Lab12AnimatedStack) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp")) #f)))
...
(define (main init-list)
  (big-bang (make-world 0 init-list 600)
            [on-tick tick]
            [to-draw draw]
            [on-mouse add-ball]))
;-------------------------------------------------------------------------
...
(define (draw wor)
  (foldr (make-drawer (world-t wor)) (square 800 'solid 'black) (world-balls wor)))
;-------------------------------------------------------------------------
...
(define (draw-ball ba pos im)
  (place-image ((select-random shape-list 3) (ball-r ba) (ball-mode ba) (ball-color ba))
               (posn-x pos)
               (posn-y pos)
               im))
;-------------------------------------------------------------------------
