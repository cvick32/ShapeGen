...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Lab12StarStack) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp")) #f)))
...
(define (draw-ball ba pos im)
  (place-image ((select-random shape-list 2) (ball-r ba) (ball-mode ba) (ball-color ba))
               (posn-x pos)
               (posn-y pos)
               im))
;-------------------------------------------------------------------------
...
(define shape-list (list circle square))
